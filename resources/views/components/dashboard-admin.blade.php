@props(['jumlahPengaduan', 'sedangDiproses', 'selesai', 'jumlahMasyarakat', 'jumlahPetugas'])
<div class="flex-1 p-8 overflow-y-auto">
    <div class="grid grid-cols-3 gap-6">
        <!-- Jumlah Pengaduan -->
        <div class="bg-white shadow-md rounded-lg p-4">
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" fill="blue">
                    <path
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24" height="24" fill="orange">
                    <path
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" fill="green">
                    <path
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            <div class="flex items-center space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="24" height="24" fill="red">
                    <path
