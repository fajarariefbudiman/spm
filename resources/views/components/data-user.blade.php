...
<div class="container mx-auto px-4 lg:px-8 mt-6">
    <div class="bg-white rounded-lg shadow-md p-6 max-w-5xl mx-auto">
        <!-- Header Section -->
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Data Masyarakat</h2>

        <!-- Button Tambah -->
        <div class="my-7 text-left">
            <a href="{{ route('user.create', ['level' => 'user']) }}"
            ...
            <table class="w-full border-collapse bg-white shadow-sm">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-sm font-medium text-gray-600 uppercase border-b">NIK</th>
                        <th class="px-6 py-3 text-center text-sm font-medium text-gray-600 uppercase border-b">No. HP
                        </th>
                        <th class="px-6 py-3 text-center text-sm font-medium text-gray-600 uppercase border-b">Email
                        </th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 text-center text-sm text-gray-700 border-b">{{ $user->nik }}</td>
                            <td class="px-6 py-4 text-center text-sm text-gray-700 border-b">{{ $user->no_hp }}</td>
                            <td class="px-6 py-4 text-center text-sm text-gray-700 border-b">{{ $user->email }}</td>
                            <td class="px-6 py-4 text-center text-sm text-gray-700 border-b">
                                <div class="flex justify-center space-x-3">
                                    ...
                                    <a href="{{ route('user.edit', ['level' => 'user', 'id' => $user->id]) }}"
                                        class="inline-flex items-center text-blue-500 hover:text-blue-700">
...
<script>
    ...
    function showDeleteConfirmation(id) {
        ...
        form.action = "{{ route('user.destroy', ['level' => 'user', 'id' => ':id']) }}".replace(':id', id);
